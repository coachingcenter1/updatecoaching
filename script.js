(function () {
  ...
  if (syllabusToggle && syllabusBody) {
    syllabusToggle.addEventListener('click', function () {
      const isOpen = syllabusBody.classList.contains('is-open');
      if (isOpen) {
        syllabusBody.classList.remove('is-open');
        syllabusToggle.setAttribute('aria-expanded', 'false');
        syllabusBody.setAttribute('aria-hidden', 'true');
      } else {
        syllabusBody.classList.add('is-open');
        syllabusToggle.setAttribute('aria-expanded', 'true');
        syllabusBody.setAttribute('aria-hidden', 'false');
      }
    });
  }
  ...
  if (benefitsToggle && benefitsBody) {
    benefitsToggle.addEventListener('click', function () {
      const isOpen = benefitsBody.classList.contains('is-open');
      if (isOpen) {
        benefitsBody.classList.remove('is-open');
        benefitsToggle.setAttribute('aria-expanded', 'false');
        benefitsBody.setAttribute('aria-hidden', 'true');
      } else {
        benefitsBody.classList.add('is-open');
        benefitsToggle.setAttribute('aria-expanded', 'true');
        benefitsBody.setAttribute('aria-hidden', 'false');
      }
    });
  }
})();
